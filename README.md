...
- UI types vary between servers, so choose one.
```
{
   "diagnostics.globals": [
      "arg",
   ...
   "type.inferParamType": true,
	"type.maxUnionVariants": 0,
   "workspace.library": [
		"wow-api-type-definitions/Client",
		"wow-api-type-definitions/UI_Turtle"
	]
}
```
...
- Lua/XML interface source [(Turtle)](https://github.com/refaim/Turtle-WoW-UI-Source)
- Lua/XML interface source [(Vanilla)](https://github.com/MOUZU/Blizzard-WoW-Interface)
