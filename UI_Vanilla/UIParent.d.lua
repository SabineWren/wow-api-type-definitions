...
---@nodiscard
function BuildListString(...) end

---@param ... any (type not inferred)
---@return any string (type not inferred)
---@nodiscard
function BuildColoredListString(...) end
...
---@param frame any (type not inferred)
---@param topOffset any (type not inferred)
---@param bottomOffset any (type not inferred)
---@param leftOffset any (type not inferred)
---@param rightOffset any (type not inferred)
---@return nil
...
---@param returnAbbr any (type not inferred)
---@return string ""
---@nodiscard
