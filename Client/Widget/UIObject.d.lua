...
--- - Derivatives of Texture will return nil for the TextureBase type.
--- - Derivatives of Frame will return 1 for the Region type, but not all methods in the documentation for Region are available on Frames.
--- - All objects return nil for: AnimatableObject, FrameScriptObject, ScriptRegion, ScriptRegionResizing
---@return nil|1 isType
---@nodiscard
